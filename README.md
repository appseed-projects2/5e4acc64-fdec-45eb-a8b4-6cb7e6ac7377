...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-03 23:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5e4acc64-fdec-45eb-a8b4-6cb7e6ac7377.git
$ cd 5e4acc64-fdec-45eb-a8b4-6cb7e6ac7377
```
